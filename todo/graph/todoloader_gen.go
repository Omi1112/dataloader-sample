...
func (l *TodoLoader) Load(key int) (*model.Todo, error) {
...
func (l *TodoLoader) LoadThunk(key int) func() (*model.Todo, error) {
	l.mu.Lock()
...
func (l *TodoLoader) LoadAll(keys []int) ([]*model.Todo, []error) {
...
// This method should be used if you want one goroutine to make requests to many
// different data loaders without blocking until the thunk is called.
func (l *TodoLoader) LoadAllThunk(keys []int) func() ([]*model.Todo, []error) {
	results := make([]func() (*model.Todo, error), len(keys))
	for i, key := range keys {
		results[i] = l.LoadThunk(key)
	}
...
func (l *TodoLoader) Prime(key int, value *model.Todo) bool {
	l.mu.Lock()
	var found bool
...
func (l *TodoLoader) Clear(key int) {
	l.mu.Lock()
	delete(l.cache, key)
	l.mu.Unlock()
}

func (l *TodoLoader) unsafeSet(key int, value *model.Todo) {
	if l.cache == nil {
...
func (b *todoLoaderBatch) keyIndex(l *TodoLoader, key int) int {
